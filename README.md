...
The console comes with a 188-in-one internal rom, labelled GBCK003. It contains in real only 66 different games with repeated entries in the menu. All games are arcade classics of the early Game Boy library (there is apparently no obvious bootleg), mostly MBC1 and no mapper games (there is at least one MBC2 game), sometimes Japanese versions. Few games have save features but they are just broken. 
