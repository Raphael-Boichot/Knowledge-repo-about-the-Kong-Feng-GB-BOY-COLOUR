...
The GB Boy Colour is a Chinese Game Boy Color clone from brand new parts made by the Kong Feng Company (KF). The model follows the GB Boy, a Game Boy clone. The GB Boy Colour is now apparently discontinued and replaced by a GBA clone. The (laughable) consequence is that the GB Boy Colour is now more expensive than an orginal GBC in 2023. As usual with Chinese repro, there is no available documentation and the origin of the KF main processor is not documented (pure reverse engineering or just leak of the masks, who knows).
